<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" class="no-js no-jr">
  <head>
    ...
    <link rel="stylesheet" href="/<?php print drupal_get_path('module','book_pubreader'); ?>/book_pubreader.css" type="text/css" />
    <style type"text/css">
    section h1, section h2, section h3, section h4 
    {
      color: <?php print variable_get('book_pubreader_header_color'); ?>;
    }
    </style>
  </head>
          ...
          <div class="flexh tb">
            <div id="jr-tb1">
              <a id="jr-pmc-sw" href="/" class="btn link wsprkl"
                title="<?php echo variable_get('site_name', 'Drupal'); ?>">
                <!--
                <img src="<?php print $pubreader_path; ?>/img/shanti_logo-icon.png" alt="pmc logo" />
                SHANTI Essays
                -->
                <?php echo variable_get('site_name', 'Drupal'); ?>
              </a>

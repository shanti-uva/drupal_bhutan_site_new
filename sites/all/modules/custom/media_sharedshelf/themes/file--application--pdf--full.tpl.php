...
<div id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <div class="file-content"<?php print $content_attributes; ?>>
	...
	<aside class="content-resources col-xs-6 col-sm-3 col-md-3 col-lg-2 sidebar-offcanvas ">
    <ul class="nav nav-pills nav-stacked">
	  ...
	  <!-- Tab panes -->
	  <section class="content-section col-xs-12 col-sm-12 col-md-9 col-lg-10 ">

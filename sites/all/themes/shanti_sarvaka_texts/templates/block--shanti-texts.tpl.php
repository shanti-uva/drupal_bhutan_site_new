	...
	<div class="content"<?php print $content_attributes; ?>>
		<div id="quicktabs-search_qt" class="tabbable">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#quicktabs-search_qt1">Title</a></li>
				<li><a data-toggle="tab" href="#quicktabs-search_qt2">Full Text</a></li>
			</ul>
			<div class="tab-content">
				<div id="quicktabs-search_qt1" class="tab-pane active">
					<?php print views_embed_view('text_search','block_3'); ?>
				</div>
				<div id="quicktabs-search_qt2" class="tab-pane">
					<?php #print views_embed_view('full_text_local','block_1'); ?>
					<?php print views_embed_view('full_text_local_2','block'); ?>
				</div>
			</div>
		</div>
	</div>

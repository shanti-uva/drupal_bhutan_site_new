...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
      ...
      <?php else: ?>
         ...
         <div class="vis-kmaps">
             <?php if (!empty($content['field_subjects_kmap'])): ?>
                 <div class="vis-subjects" title="Click to view Subject Kmaps">
                     <a class="vis-kmaps-show-link"><span class="icon shanticon-subjects"></span></a> 
                 </div>
                 <div class="kmap-content vis-subjects" style="display:none;">
                      <a class="vis-kmaps-close"><span class="icon shanticon-close2"></span></a>
                      <?php  print render($content['field_subjects_kmap']);  ?>
                 </div>
             <?php endif; ?>
             <?php if (!empty($content['field_places_kmap'])): ?>
                 <div class="vis-places" title="Click to view Places Kmaps">
                     <a class="vis-kmaps-show-link"><span class="icon shanticon-places show-link"></span> </a>
                 </div>
                 <div class="kmap-content vis-places" style="display:none;">
                     <a class="vis-kmaps-close"><span class="icon shanticon-close2"></span></a>
